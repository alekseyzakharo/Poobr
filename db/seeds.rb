...
Posting.create(title: 'Vancouver 14', address: '463 Robson St, Vancouver BC', description: 'Bathroom', infant: true, handicap: true, shower: true, userid:1, price:5)
Posting.create(title: 'Vancouver 15', address: '678 Dunsmuir St, Vancouver BC', description: 'Bathroom', infant: false, handicap: true, shower: true, userid:1, price:5)
...
Posting.create(title: 'Vancouver 17', address: '650 W Georgia St, Vancouver BC', description: 'Free', infant: false, handicap: false, shower: true, userid:1, price:0)
Posting.create(title: 'Vancouver 18', address: '555 W Hastings St, Vancouver BC', description: 'Bathroom', infant: true, handicap: true, shower: true, userid:1, price:5)
...
Posting.create(title: 'Vancouver 20', address: '756 Davie St, Vancouver BC', description: 'Small Pleasant Bathroom', infant: true, handicap: true, shower: true, userid:1, price:5)
...
Posting.create(title: 'Vancouver 22', address: '200 Burrard St, Vancouver BC', description: 'Nice Large Shower and Bathroom', infant: true, handicap: false, shower: false, userid:1, price:5)
